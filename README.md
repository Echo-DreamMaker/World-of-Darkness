<div align="center"><img alt="WWDP logo" src="https://github.com/Echo-DreamMaker/World-of-Darkness/blob/master/Resources/Textures/_White/Logo/World%20of%20Darkness.png" width="512px" /></div>

---

World of Darkness - это форк билда Night City 2045, который является форком билда WWDP.
...
Обратите внимание, что активы, созданные командой WWDP и ED (NC и прочих), лицензированы под некоммерческой [CC-BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/) или аналогичной некоммерческой лицензией и должны быть удалены, если вы хотите использовать этот проект в коммерческих целях. В случае, если в файле метаданных указано иное - укажите нам об этом, прошлая лицензия будет применяться ретроактивно вместе с CC-BY-NC-SA 4.0.

Я, (GH:Yasherke, DS:nre500), как автор оригинального кода в данном репозитории, заявляю что запрещаю монетизировать данные механики и разрешаю их распространение только на некоммерческой основе по лицензии [LICENSE-ICLA-EN](./LICENSE-ICLA-EN.txt).
Остальные механики, портированные и перенесённые из других проектов - лицензируются под [LICENSE-AGPLv3](./LICENSE-AGPLv3.txt) как и указано в разделе "лицензия", по двойной лицензии.
